...
public class Utils {
     ...
     */
    public static String getFormattedWind(Context context, double windSpeedStr,
	    double windDirStr) {
	int windFormat;
	...
	return String.format(context.getString(windFormat), windSpeedStr,
		direction);
    }
